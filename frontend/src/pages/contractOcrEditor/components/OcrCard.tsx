...
import { ZoomIn, RefreshCw, CircleAlert as AlertCircle, CircleCheck as CheckCircle2, Loader as Loader2, Clock, ChevronDown, ChevronUp } from 'lucide-react'
        ...
        <div className="flex items-center gap-2">
          ...
          {onToggleCollapse && (
            <Button
              ...
              aria-label={collapsed ? '展开内容' : '收起内容'}
            >
              {collapsed ? (
